...
//           className="w-10 h-10 rounded-full border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 
//             shadow-md hover:shadow-lg dark:shadow-zinc-900/50 
...
//       <div className="relative z-10 flex md:flex-row flex-col min-h-[calc(100vh-80px)] gap-8 md:gap-20 items-center md:px-20 p-6">
//         <div className="text-start pr-2 md:w-1/2">
...
//                   bg-zinc-50/80 dark:bg-zinc-950/80 p-4 text-sm 
...
//                   </div>
//                   <span className="text-zinc-700 dark:text-zinc-300">Secure</span>
//                 </div>
...
//                   </div>
//                   <span className="text-zinc-700 dark:text-zinc-300">Multi-Sig</span>
//                 </div>
...
//                   </div>
//                   <span className="text-zinc-700 dark:text-zinc-300">Trustless</span>
//                 </div>
//               </div>
