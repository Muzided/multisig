...
/** Creator-only modal to set a due date on a milestone that doesn't have one yet */
export const SetDueDateModal = ({
  open, onOpenChange, selectedDate, onDateChange, minDate, loading, onSave,
}: Props) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <DialogFooter>
          ...
          >
            {loading ? "Processing..." : "Set Due Date"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
